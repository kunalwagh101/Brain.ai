...
Retention/deletion boundary: DM records follow the organisation's configured retention/deletion policy when such policy is explicitly configured; Brain does not invent a legal retention period. Membership removal immediately removes the user's ability to open the organisation or any DMs there.  
